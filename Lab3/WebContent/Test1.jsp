...
<body>
	...
	<form action="ChangePass">
		<p>Stare haslo:</p>
		<input type="text" type="password" name="oldPass" value="${ param.oldPass }">
		<p>Nowe haslo:</p>
		<input type="text" type="password" name="newPass" value="${ param.newPass }" >
		<p>Powtorz nowe haslo:</p>
		<input type="text" type="password" name="newPass1" value="${ param.newPass1 }" >
		<br/><br/>
...
<table border="2" style="visibility: visible">
   <tr>
        <td>IP</td>
        <td>Operacja</td>
        <td>Data</td>
